...
impl interface::WlanDevice for NullWlan {
...
static CURR_WLAN: IrqSafeNullLock<&'static (dyn interface::WlanDevice + Sync)> =
    IrqSafeNullLock::new(&NULL_WLAN);

/// Register a new console.
pub fn register_wlan(new_console: &'static (dyn interface::WlanDevice + Sync)) {
    CURR_WLAN.lock(|con| *con = new_console);
}

/// Return a reference to the currently registered console.
pub fn wlan() -> &'static dyn interface::WlanDevice {
