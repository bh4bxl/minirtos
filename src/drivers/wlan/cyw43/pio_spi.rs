...
impl PioSpi {
    ...
    pub(super) fn init_hw(&mut self, pio0: pac::PIO0, resets: &mut pac::RESETS) {
    ...
    #[inline]
    pub(super) fn start_spi_comms(&self) {
    ...
    #[inline]
    pub(super) fn stop_spi_comms(&self) {
        self.set_cs_high();
    ...
    pub(super) fn transfer(&mut self, tx_buf: &[u8], rx_buf: &mut [u8]) -> Result<usize, DevError> {
